  ...
  return (
    <div className="bg-gradient-to-r from-[#4F39F6] to-[#9514FA] py-10 px-5 flex flex-col justify-center items-center md:py-[120px]">
      ...
      <div className="mt-4 flex  justify-center items-center space-x-2    ">
        <button className="btn bg-white py-3 px-4 rounded-full text-[#9514FA]   ">Explore Products</button>
        <button className="btn bg-transparent text-white py-3 px-4 rounded-full    ">View Pricing</button>
      </div>
